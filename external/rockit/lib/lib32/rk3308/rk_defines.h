...
/* Automatic generated [rk3308] config */
...
/* For VDEC */
#define VDEC_MAX_CHN_NUM               1

/* For Region */
#define RGN_MAX_HANDLE_NUM             128
#define RGN_EXTRA_DEVICE_TYPE          0
...
/* For VGS */
#define VGS_MAX_JOB_NUM                0
#define VGS_MAX_TASK_NUM               0
...
#define GDC_MAX_TASK_NUM               0

/* For IVS */
#define IVS_MAX_CHN_NUM                32

/* For AVS */
#define AVS_MAX_GRP_NUM                0
#define AVS_PIPE_NUM                   0
#define AVS_MAX_CHN_NUM                0
